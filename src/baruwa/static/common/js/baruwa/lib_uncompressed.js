...
function json2html(data){
    if(data){
        ...
        var statusimg = media_url + 'mail/imgs/' + simg;
        ...
        $.each(data.items,function(i,n){
            ...
            rows[count++] = '<div class="Date_Time"><a href="'+messages_base_url+view+'/'+n.id+'/">'+n.timestamp+'</a></div>';
            rows[count++] = '<div class="From_row"><a href="'+messages_base_url+view+'/'+n.id+'/">'+from+'</a></div>';
            rows[count++] = '<div class="To_row"><a href="'+messages_base_url+view+'/'+n.id+'/">'+to+'</a></div>';
            rows[count++] = '<div class="Subject_row"><a href="'+messages_base_url+view+'/'+n.id+'/">'+subject+'</a></div>';
            rows[count++] = '<div class="Size_row"><a href="'+messages_base_url+view+'/'+n.id+'/">'+filesizeformat(n.size)+'</a></div>';
            rows[count++] = '<div class="Score_row"><a href="'+messages_base_url+view+'/'+n.id+'/">'+n.sascore+'</a></div>';
            rows[count++] = '<div class="Status_row"><a href="'+messages_base_url+view+'/'+n.id+'/">'+mstatus+'</a></div>';
            rows[count++] = '</div>';
        });
        if(!rows.length){
