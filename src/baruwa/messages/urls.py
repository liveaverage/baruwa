...
urlpatterns = patterns('baruwa.messages.views',
    ...
    (r'^quarantine/spam/$', 'index', {'list_all': 1,'quarantine': 1, 'show_only': 1}, 'quarantine-spam-index'),
    (r'^quarantine/other/$', 'index', {'list_all': 1,'quarantine': 1, 'show_only': 2}, 'quarantine-other-index'),
