...
urlpatterns = patterns('baruwa.web.config.views',
    ...
    (r'^destinations/local/$', 'destinations', {'local': 1}, 'destination-rules-local'),
    (r'^destinations/nonlocal/$', 'destinations', {'local': 2}, 'destination-rules-nonlocal'),
    (r'^destinations/(?P<page>(\d+|last))/$', 'destinations', {},
    'destination-rules-paged'),
    (r'^destinations/local/(?P<page>(\d+|last))/$', 'destinations', {'local': 1},
    'destination-rules-local-paged'),
    (r'^destinations/nonlocal/(?P<page>(\d+|last))/$', 'destinations', {'local': 2},
    'destination-rules-nonlocal-paged'),
